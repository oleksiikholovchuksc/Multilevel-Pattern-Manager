...
public:
    bool exec() override {
        ...
        std::shared_ptr<Model::SimpleExpression> S1 = std::make_shared<Model::SimpleExpression>(0, "S1", S1_args);
        ...
        std::shared_ptr<Model::SimpleExpression> S2 = std::make_shared<Model::SimpleExpression>(0, "S2", S2_args);

        /*
         *    Create S3
         */
        std::vector<std::shared_ptr<Model::IExpression>> S3_args = { S1, S2 };
        std::shared_ptr<Model::SimpleExpression> S3 = std::make_shared<Model::SimpleExpression>(0, "S3", S3_args);
        ...
        std::shared_ptr<Model::SimpleExpression> S6 = std::make_shared<Model::SimpleExpression>(0, "S6", S6_args);

        /*
         *    Create S4
         */
        std::vector<std::shared_ptr<Model::IExpression>> S4_args = {S1->clone(), S6};
        std::shared_ptr<Model::SimpleExpression> S4 = std::make_shared<Model::SimpleExpression>(0, "S4", S4_args);
